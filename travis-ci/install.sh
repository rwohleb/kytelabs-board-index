...
# based heavily off of the Adafruit Arduino Travis CI project: https://github.com/adafruit/travis-ci-arduino
...
# this will be eval'd in the functions below because arrays can't be exported
export AUX_PLATFORMS='declare -A aux_platforms=( [bleduino]="kytelabs:avr:bleduino" )'
...
#ln -s $PWD $HOME/arduino_ide/libraries/Kytelabs_Test_Library
